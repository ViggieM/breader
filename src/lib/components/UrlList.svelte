        ...
        <li id={bookmark.id}>
            <details>
                ...
                <article>
                    ...
                    <footer>
                        <span
                            >Added on <time datetime={bookmark.created}
                                >{formatDate(bookmark.created)}</time
                            ></span
                        >
                        {#if bookmark.hasBody}
            ...
            <details class="dropdown dropdown-end absolute right-0 top-0">
                <summary
                    ><span class="text-lg icon-[ri--more-2-line]"
                    ></span></summary
                >
                    ...
                    <li>
                        <label class="flex justify-between">
                            ...
                            <input
                                ...
                                onchange={(event) =>
                                    markAsRead(event, bookmark.id)}
                            />
                        </label>
                    </li>
                    <li>
                        <a
                            href={bookmark.localUrl}
                            class="flex justify-between"
                        >
                            Edit <span class="size-4 icon-[ri--pencil-line]"
                            ></span>
                        </a>
                    </li>
                    <li>
                        <button class="flex justify-between text-error">
                            Delete <span
                                class="size-4 icon-[ri--delete-bin-6-line]"
                            ></span>
                        </button>
                    </li>
                </ul>
