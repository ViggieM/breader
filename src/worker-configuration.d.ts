/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./src/worker-configuration.d.ts` (hash: 52d50824cf7abaf29dd835381b449768)
// Runtime types generated with workerd@1.20251210.0 2025-08-23 nodejs_als
declare namespace Cloudflare {
	interface Env {
		PUBLIC_POSTHOG_HOST: 'https://eu.i.posthog.com';
		PUBLIC_POSTHOG_API_KEY: 'phc_NR9M5Ths1OHhD96ufDpH1Cu0GFl5KFulPza6X4RFrZT';
		PUBLIC_SUPABASE_URL: string;
		PUBLIC_SUPABASE_ANON_KEY: string;
		OPENAI_API_KEY: string;
		PUBLIC_DEXIE_CLOUD_DB_URL: string;
		DEXIE_CLOUD_CLIENT_ID: string;
		DEXIE_CLOUD_CLIENT_SECRET: string;
